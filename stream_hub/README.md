...
📂 Sidebar navigation with sections for Home, Shorts, Subscriptions, History, Watch Later, etc.

🔍 Search bar with microphone button (UI only)

📹 Video card layout with thumbnails, durations, views, and channel info

📱 Mobile-friendly sidebar toggle and overlay behavior

🖱️ Smooth hover and UI interactions
...
logo.png and user.jpg (or replace with your own)
